...
GETGLOB() ;
 ...
 ;
EXECUTE(XTDEBUGX) ;
 N I,EXT,RTN,XTDEBUGX1,P
 F I=2:1 S P=$P(XTDEBUGX,"$$",I) Q:P=""  D
 . S XTDEBUGX1=$P(XTDEBUGX,"$$",1,I-1)
 . S EXT=$P(XTDEBUGX,"$$",I,99),RTN=$P(EXT,"(")
 . S XTDEBUGX1=XTDEBUGX1_$S($P(RTN,"^",2)="":"$$"_RTN_"^"_XTDEBROU_"("_$P(EXT,"(",2,99),1:"$$"_EXT)
