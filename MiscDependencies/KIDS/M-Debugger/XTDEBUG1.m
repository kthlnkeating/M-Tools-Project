XTDEBUG1 ;JLI/OAK_OIFO- ;05/30/13  22:16
...
DO ;
 ...
 . S ARG=$G(XTDEBARG("ARGS",XTDEBNUM))
...
KILL ;
 ...
 I XTDEBCON,XTDEBARG("CMND")?1(1"K",1"k"),(XTDEBARG("ARGS",XTDEBNUM)="")!($E(XTDEBARG("ARGS",XTDEBNUM))="(") Q  ; D REASON^XTDEBUG("EXCLKILL") Q
 I XTDEBCON,XTDEBARG("CMND")?1(1"K",1"k") S XTDEBXXX="K "_XTDEBARG("ARGS",XTDEBNUM) D EXECUTE(XTDEBXXX) D DEBUG^XTMLOG("COMMANDS_KILL","XTDEBXXX")
...
GETGLOB() ;
 ...
 ;
EXECUTE(XTDEBUGX) ;
 N XTDEBUGI,XTDEBUGEX,XTDEBUGRT,XTDEBUGX1,XTDEBUGP
 F XTDEBUGI=2:1 S XTDEBUGP=$P(XTDEBUGX,"$$",XTDEBUGI) Q:XTDEBUGP=""  D
 . S XTDEBUGX1=$P(XTDEBUGX,"$$",1,XTDEBUGI-1)
 . S XTDEBUGEX=$P(XTDEBUGX,"$$",XTDEBUGI,99),XTDEBUGRT=$P(XTDEBUGEX,"(")
 . S XTDEBUGX1=XTDEBUGX1_$S($P(XTDEBUGRT,"^",2)="":"$$"_XTDEBUGRT_"^"_XTDEBROU_"("_$P(XTDEBUGEX,"(",2,99),1:"$$"_XTDEBUGEX)
