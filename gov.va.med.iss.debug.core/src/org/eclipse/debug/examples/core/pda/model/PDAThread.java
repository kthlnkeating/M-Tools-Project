 ...
 */
public class PDAThread extends PDADebugElement implements IThread {
	...
	public IStackFrame[] getStackFrames() throws DebugException {
		if (isSuspended()) {
			return ((PDADebugTarget)getDebugTarget()).getStackFrames();
		} else {
	...
	public void stepOver() throws DebugException {
		((PDADebugTarget)getDebugTarget()).step();
	}
	/* (non-Javadoc)
