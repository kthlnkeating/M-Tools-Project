...
//			rouLoad.loadRoutine(routineName,true); --jspivey/TODO: note on existing code: this appears to be auto handling the dependency of "what if a user debugs a routine that isn't loaded". in our case will will only debug routines that are already loaded into eclipse? we may need to do the same where it calls load routine
//			editor = getEditor(routineName);
//		}
//		if (editor != null) {
...
//		MDebuggerConsoleDisplay.updateView(strLineText, true); //jspivey-- commenting out
