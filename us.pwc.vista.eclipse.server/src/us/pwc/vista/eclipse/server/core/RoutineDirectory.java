...
public class RoutineDirectory {
	 ...
	 */
	public static String getRoutineList(VistAConnection vistaConnection, String routineName) {
		String str = getRoutineNames(vistaConnection, routineName);
	 ...
	 * @return
	 */
	public static String getRoutineNames(VistAConnection vistaConnection, String routineName) {
		str = "";
		if ( ! (routineName.compareTo("") == 0)) {
			try {
				String result = vistaConnection.rpcXML("XT ECLIPSE M EDITOR", "RD", "notused", routineName);				
