...
public class VFRepoScanner {
	
	private File vistaFoiaPath;
	
	public VFRepoScanner(File vistaFoiaPath) {
		//vistaFoiaPath = System.getenv("VistA-FOIA");
		this.vistaFoiaPath = vistaFoiaPath;
	}

	public Map<String,String> loadPackages() {
		Map<String,String> results = new TreeMap<String,String>();
		
		File packagesFile = new File(vistaFoiaPath, "Packages.csv");

		Scanner scanner = null;;
		try {
			scanner = new Scanner(packagesFile);
		} catch (IOException e) {
			e.printStackTrace();
