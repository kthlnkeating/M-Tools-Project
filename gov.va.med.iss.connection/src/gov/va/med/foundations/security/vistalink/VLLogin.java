 ...
 * @version 1.0.0.193
 * */
public final class VLLogin implements LoginModule {
	...
	private static final Logger LOGGER = Logger.getLogger(VLLogin.class);
	...
	public boolean login()
		...
		int serverPort = -1;
		String exceptionMessage = "VLLogin login method failed.";
